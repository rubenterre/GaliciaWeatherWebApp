...
function abrirBotonOurense() {
  ...
  //ajax
  const url = `https://api.openweathermap.org/data/2.5/weather?id=3114965&appid=3e867330616c39fa60d18a1af5d82f16&units=metric&lang=gl`;
